...
function Movie_Theaters() {

    const [hoveredCard, setHoveredCard] = useState(null);
    const scrollContainer = useRef(null);
    const [page, setPage] = useState([2]);
    useEffect(() => {
        fetch(`https://apii.online/nguonc/danh-sach?year=2023&type=single&page=1`)
    ...
    return (
        <div className=" w-full inset-0 mt-5">
            <h2 className='ml-10 mt-0 text-[28px] text-white font-semibold'>Phim Chiếu Rạp</h2>
            <div className="pt-5 pl-10 overflow-y-auto scrollbar-hide h-[670px]" ref={scrollContainer}>
                {page.map((card, index) => {
