...
function Movie_bo() {
    ...
    useEffect(() => {
        fetch(`https://apii.online/nguonc/danh-sach?year=2023&type=series&country=trung-quoc&category=tinh-cam%2Cphieu-luu%2Cco-trang%2Cvien-tuong%2Ckhoa-hoc%2Cthan-thoai%2Clang-man%2Choc-duong&page=1`)
    ...
    return (
        <div className="w-full">
            <h2 className=' ml-10 pt-5 text-[28px] text-white font-semibold'>Phim Bộ</h2>
