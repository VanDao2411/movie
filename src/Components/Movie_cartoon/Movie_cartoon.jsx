...
function Movie_cartoon() {
    ...
    useEffect(() => {
        fetch(`https://apii.online/nguonc/danh-sach?year=2023&type=hoathinh&page=1`)
    ...
    return (
        <div className="w-full">
            <h2 className=' ml-10 pt-5 text-[28px] text-white font-semibold'>Hoạt Hình</h2>
